...
echo("
<form method='post' action='admin_update_action.php?sessionid=$sessionid&userid=$userid'>
UserId (Required Up to 7 digits): <input type='text' value = '$userid' maxlength='5' name='userid' disabled> <br /> 
